...
int BaseManager::getrefieneryBuildPriority(){
...
std::map<BWTA::BaseLocation*,Base*> BaseManager::getL2B() const{


	return this->location2base;
}
...
BWTA::BaseLocation* BaseManager::expand(BWTA::BaseLocation* location, int priority)
{
  ...
  //this->builder->buildAdditional(5,BWAPI::UnitTypes::Terran_Siege_Tank_Tank_Mode,priority-5,location->getTilePosition());
