...
public:
	...
	TTEntry();
	TTEntry(const HashType & hash2, const AlphaBetaScore & score, const size_t & depth, const int & type, 
	...
	const AlphaBetaScore & getScore()							const;
...
{
	//Array<TTEntry, Search::Constants::Transposition_Table_Size>	TT;
	//TTEntry TT[Search::Constants::Transposition_Table_Size];
...
public:
	...
	void save(	const HashType & hash1, const HashType & hash2, const AlphaBetaScore & value, const size_t & depth, const int & type,
				const IDType & firstPlayer, const AlphaBetaMove & bestFirstMove, const AlphaBetaMove & bestSecondMove);
