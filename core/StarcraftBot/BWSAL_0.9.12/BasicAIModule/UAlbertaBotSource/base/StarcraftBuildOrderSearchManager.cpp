...
BuildOrderSearch::StarcraftState StarcraftBuildOrderSearchManager::getCurrentState()
{
	...
	s.setMineralWorkers((unsigned char)UAWorkerManager::Instance().getNumMineralWorkers());
	s.setGasWorkers((unsigned char)UAWorkerManager::Instance().getNumGasWorkers());
