...
class CombatCommander
{
	...
	// **** Newly added functions by Dustin Dannenhauer

						// takes a region and orders units to attack that region
	void				assignAttackRegion(std::set<BWAPI::Unit *> & unitsToAssign, BWTA::Region * r);
	// ****
...
public:
	...
	// **** Newly added functions by Dustin Dannenhauer
						...
						// sets the enemy base that we are going to attack
	void				setEnemyBase(BWTA::Region* r);
	// ****

private:
	BWTA::Region* enemyBaseRegion;
};