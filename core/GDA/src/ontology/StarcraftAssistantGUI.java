...
//        updateProgressBar(jenaOntologyModel);
    ...
    public void updateEnemyAbilities() {
        ...
        ResultSet results = OntologyInfo.queryEnemyAbilities();
    ...
    public void updateRegionStates() {
        ResultSet resultsC = OntologyInfo.queryContestedRegions();
        ...
        ResultSet resultsB = OntologyInfo.queryBattleRegions();
        ...
        int mapHeight = 96 * 32;
        int mapWidth = 128 * 32;
        ResultSet myUnitsResults = OntologyInfo.queryMyUnits();
        ...
        ResultSet enemyUnitsResults = OntologyInfo.queryEnemyUnits();
    ...
    private void updateProgressBar() {
        ResultSet results = OntologyInfo.queryArmyHealth();
        int runningCurrHP = 0;
        int runningMaxHP = 0;
        while (results.hasNext()) {
            QuerySolution soln = results.nextSolution();
