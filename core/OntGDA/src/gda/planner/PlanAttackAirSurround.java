 ...
 * @date Nov 20, 2013
 */
public class PlanAttackAirSurround implements Plan {

	private ArrayList<PlanStep> planSteps = new ArrayList<>();
	private GoalType goalType = GoalType.ATTACK_AIR_SURROUND;
	...
	public PlanAttackAirSurround() {
		...
		for (String s : p) {
			...
			this.subplans.get(0).add(new PlanAttackAirDirect(currRegionID));
		}
...
//								+ prevUnitIds.toString());
				...
				Plan newPlan = new PlanAttackAirDirect(prevUnitIds);
