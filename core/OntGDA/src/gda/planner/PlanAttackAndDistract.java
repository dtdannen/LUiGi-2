 ...
 * @date Aug 12, 2013
 */
public class PlanAttackAndDistract implements Plan {
 ...
 // note this may be changed to be a different region, like an adjacent region
     ...
     */
    public PlanAttackAndDistract(GoalType goalType, ArrayList<Pair<String, Integer>> unitTypeCounts) {
     ...
     * @param targetRegion
     */
    public PlanAttackAndDistract(GoalType goalType, ArrayList<Pair<String, Integer>> unitTypeCounts, int targetRegion) {
        this.goalType = goalType;
        PlanStep step = null;
        //this.ID++;
     ...
     * @param unitIds
     */
    public PlanAttackAndDistract(GoalType goalType, ArrayList<Integer> unitIds, boolean makeSignatureUnique) {
    	this.goalType = goalType;
        PlanStep step = null;
...
//        }
     ...
     * @param unitIds
     */
    public PlanAttackAndDistract(GoalType goalType, ArrayList<Integer> unitIds, boolean makeSignatureUnique, boolean makeSignatureUnique2) {
    	this.goalType = goalType;
        PlanStep step = null;
