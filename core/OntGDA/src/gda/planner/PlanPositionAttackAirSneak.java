 ...
 * @date Aug 12, 2013
 */
public class PlanPositionAttackAirSneak implements Plan{
    ...
    private GoalType goalType = GoalType.ATTACK_POSITION_AIR_SNEAK;
    ...
    public PlanPositionAttackAirSneak() {
        PlanStep step = null;
...
//        this.planSteps.add(step);
     ...
     */
    public PlanPositionAttackAirSneak(ArrayList<Integer> unitIds) {
     ...
     * @param targetRegion
     */
    public PlanPositionAttackAirSneak(int targetRegion) {
        ArrayList<Pair<String, Integer>> unitTypeCounts = new ArrayList<Pair<String, Integer>>();
	...
	public String toString() {
		// TODO Auto-generated method stub
		return "Position Attack Air Sneak";
	}
